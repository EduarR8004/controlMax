...
class __AlertDialog extends StatefulWidget {
  ...
  static const WARNING = Color(0xffFF8C00);  //Color(0xff2196f3);  Color(0xffFF8C00);
  static const ERROR = Color(0xffc0392b);
  static const INFO = Color(0xffafb42b);
...
class __AlertDialogState extends State<__AlertDialog> {
  ...
  _getPositiveButtonColor() {
    var color = Colors.black;//Theme.of(context).accentColor;
    if (widget.confirm) {
      if (_confirmDeleteAction) {
        color = Colors.red;
      } else {
...
waitDialog(BuildContext context, {message = "Please wait...", Duration duration}) {
  var dialog = Dialog(
    ...
    elevation: 0.0,
    backgroundColor: Colors.white,//Theme.of(context).dialogBackgroundColor,
    ...
    child: Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Text(message,style: TextStyle(color: Colors.black, fontSize: 25.0, fontWeight: FontWeight.w400 ),),
